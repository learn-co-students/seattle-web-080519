...
const ProteinForm = (props) => {
  // Because this is a functional component, we access props via "props" and not "this.props"
  // We do not have context of "this"
  // Also, for the purposes of this program, state should be housed in class components
  // and not in functional components
  console.log(props)
  return (
    <Fragment>
