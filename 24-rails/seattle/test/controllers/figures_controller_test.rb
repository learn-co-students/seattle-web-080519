...
class FiguresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create figure" do
    assert_difference('Figure.count') do
      post figures_url, params: { figure: { landmarks: @figure.landmarks, name: @figure.name, titles: @figure.titles } }
    end
  ...
  test "should update figure" do
    patch figure_url(@figure), params: { figure: { landmarks: @figure.landmarks, name: @figure.name, titles: @figure.titles } }
