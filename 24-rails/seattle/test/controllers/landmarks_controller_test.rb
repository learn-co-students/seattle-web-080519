...
class LandmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landmark" do
    assert_difference('Landmark.count') do
      post landmarks_url, params: { landmark: { name: @landmark.name, year: @landmark.year } }
    end
  ...
  test "should update landmark" do
    patch landmark_url(@landmark), params: { landmark: { name: @landmark.name, year: @landmark.year } }
